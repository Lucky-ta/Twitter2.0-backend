    ...
    getUserById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.service.userById(parsedId);
                return res.status(result.status).json(result.data);
            }
            catch (e) {
                return res.status(500).json(e.message);
...
const services = {
    editName: userService_1.editName, excludeAccount: userService_1.excludeAccount, loginUserAccount: userService_1.loginUserAccount, postUser: userService_1.postUser, userById: userService_1.userById,
};
