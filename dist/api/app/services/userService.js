...
exports.userById = exports.editName = exports.excludeAccount = exports.loginUserAccount = exports.postUser = exports.validateResponse = void 0;
...
const excludeAccount = (accountId) => __awaiter(void 0, void 0, void 0, function* () {
    yield LikedTweets.destroy({ where: { userId: accountId } });
    yield Tweet.destroy({ where: { userId: accountId } });
...
const userById = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield User.findOne({ where: { id: userId }, attributes: ['id', 'name', 'email'] });
    return (0, exports.validateResponse)(user, userMessages_1.default.userError, 200);
});
