...
describe('Test user router', () => {
    ...
    describe('GET: /user/:userId', () => {
        ...
        it('should return status code 200 with valid user ID', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield (0, supertestsFunctions_1.getUserById)(registeredUserId);
            expect(result.statusCode).toBe(200);
        }));
        it('should return user data with valid user ID', () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield (0, supertestsFunctions_1.getUserById)(registeredUserId);
            const expectResponse = {
                id: registeredUserId,
                name: userCredentials_1.default.validCredentials.name,
                email: userCredentials_1.default.validCredentials.email,
            };
            expect(result.body).toStrictEqual(expectResponse);
        }));
        it('should return status code 404 with a invalid user ID', () => __awaiter(void 0, void 0, void 0, function* () {
            const invalidUserId = '1000';
            const result = yield (0, supertestsFunctions_1.getUserById)(invalidUserId);
