...
const likeNewTweet = (userId, tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    const isTweetLiked = yield LikedTweets.findOne({ where: { userId } });
    if (isTweetLiked !== null) {
        const unlikeTweet = yield LikedTweets.destroy({ where: { userId } });
...
const filterLikedTweets = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const likedTweets = [];
    const user = yield User.findOne({ where: { id: userId }, attributes: ['id', 'name'] });
