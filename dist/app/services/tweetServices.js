...
exports.tweetsByTweetId = exports.updateTweetLike = exports.editTweet = exports.getUserTweets = exports.destroyTweet = exports.getAllTweets = exports.postTweet = void 0;
...
const tweetsByTweetId = (tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    const tweetsByTheirId = yield Tweet.findAll({
        where: { id: tweetId },
        include: [
...
exports.tweetsByTweetId = tweetsByTweetId;
