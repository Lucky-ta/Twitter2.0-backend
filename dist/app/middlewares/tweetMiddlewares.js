...
exports.likeSignValidation = exports.tweetValidation = exports.tokenValidation = void 0;
...
const likeSignValidation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { likeSign } = req.body;
    const availableSigns = ['+', '-'];
    const isValidSign = availableSigns.includes(likeSign);
    if (!likeSign || isValidSign === false)
        return res.status(404).json(tweetErrorMessages_1.default.signError);
    return next();
});
exports.likeSignValidation = likeSignValidation;
